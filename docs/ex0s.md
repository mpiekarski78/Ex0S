...
Next lab (not a stamp): [`tm012context_results.md`](tm012context_results.md) (TM.0.12.CONTEXT) — representation audit; [`tm012minimap_results.md`](tm012minimap_results.md) (TM.0.12.MINIMAP) — among preregistered candidates, `(token, origin)` is least-structured sufficient for C2–C6; C7 unobservable; [`tm012pathdisc_results.md`](tm012pathdisc_results.md) (TM.0.12.PATHDISC) — same-S C8 kills origin alone (some route info beyond origin is necessary; do not conclude full-path storage). Next after PATHDISC: H3c vs richer path — not genome yet. Do **not** invent 0.0.004 until a minimal CONTEXT primitive is earned; do not pre-name it Abstraction. LOOKAHEAD stays a separate track.
