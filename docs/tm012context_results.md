...
This pass does **not** yet rank H1–H3 sufficiency for a future genome — see **TM.0.12.MINIMAP** ([`tm012minimap_results.md`](tm012minimap_results.md)): among preregistered candidates, `(token, origin)` is the least-structured sufficient representation for C2–C6; C7 is unobservable from provenance. **TM.0.12.PATHDISC** ([`tm012pathdisc_results.md`](tm012pathdisc_results.md)) then shows origin alone is insufficient on same-S C8.
