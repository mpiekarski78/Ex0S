...
**Next:** opt-in persistence candidate under the frozen continuity-evidence contract (separate from alias fingerprints). Product stamp naming for FAMILY earn remains a human decision (`ex0s=null`).
