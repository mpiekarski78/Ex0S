...
**Next:** wall hint after INTERPRET is **honesty** (claims understand but behaves inconsistently). Product stamp stays a human decision (`ex0s=null`). No Ex0S 1.0.
