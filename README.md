...
**Next:** no product stamp. Alias fingerprints and mark-continuity persistence remain separate lab tracks. Product stamp naming for FAMILY earn remains a human decision (`ex0s=null`).
