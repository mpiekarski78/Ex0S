...
Ex0S 0.0.002  ←  TM.0.11 COMPOSE
        ...
        │
        ▼ freeze compose organism; attack with composition worlds
Ex0S 0.0.003  ←  TM.0.11.FAMILY
        depth / first-hop branch / revise-downstream
        developed 144/144 · hold-out 108/108 · hold-out depth 4 · genome delta 0
```
...
| **0.0.003** | TM.0.11.FAMILY (frozen compose) | Frozen composition generalizes across **depth, first-hop branching, downstream revision** |
...
Honest status: **Ex0S 0.0.003** freezes compose across 252 composition worlds (**252/252**; hold-out depth 4; G revise-downstream with upstream hash stable). **Ex0S 0.0.002** / **0.0.001** still stand. **B Fail** on the no-cue English motor bar stays — do not green it by lookahead or hop flags.
...
TM.0.6.3 new-here stamp: [`docs/tm063_results.md`](docs/tm063_results.md).  
TM.0.6.4 English find without unique rare: [`docs/tm064_results.md`](docs/tm064_results.md).  
TM.0.6.5 concurrent bind: [`docs/tm065_results.md`](docs/tm065_results.md).  
TM.0.6.6 correct dirty English S: [`docs/tm066_results.md`](docs/tm066_results.md).  
TM.0.6.7 in-hand new-here: [`docs/tm067_results.md`](docs/tm067_results.md).  
TM.0.6.8 find-novel: [`docs/tm068_results.md`](docs/tm068_results.md).  
TM.0.6.9 find-novel without unique two-rare: [`docs/tm069_results.md`](docs/tm069_results.md).  
...
TM.0.8.1 one return: [`docs/tm081_results.md`](docs/tm081_results.md).  
TM.0.8.2 one machine: [`docs/tm082_results.md`](docs/tm082_results.md).  
...
| TM.0.6.3 A new-here stamp / B shared return | **Store-works** / **Store-works** (C life on dirty English S stamps `adjust`; shared return not the jump) |
| TM.0.6.4 A English find without unique rare / B shared return | **Fail** / **Store-works** (clutter hapax bound as acts; motors still PRESS/TUNE; shared return not the jump) |
| TM.0.6.5 A concurrent bind / B shared return | **Store-works** / **Fail** (one CS here from the page in play; shared return first-CS `neon`, C miss) |
| TM.0.6.6 A correct dirty English S / B shared return | **Fail** / **Store-works** (train S n=1 `push`; C bound `xenon`; shared return not the jump) |
| TM.0.6.7 A in-hand new-here / B shared return | **Fail** / **Store-works** (leftover walk gone; C bound `neon` in-hand; shared return not the jump) |
| TM.0.6.8 A find-novel / B shared return | **Store-works** / **Store-works** (C bound `adjust`; shared return not the jump) |
| TM.0.6.9 A find-novel without unique two-rare / B shared return | **Fail** / **Store-works** (train bound `neon`, C bound `xenon`; shared return not the jump) |
...
| TM.0.8.1 A one return / B motor bar | **Fail** / **Store-works** (split gone; retrieve used `xenon`; motor bar not the English bar) |
...
| TM.0.11.FAMILY frozen compose (**Ex0S 0.0.003**) | **252/252** (A–D 144/144; hold-out E–G 108/108; depth 4; G upstream hash stable) |
...
| TM.0.6.3 new-here stamp | **Store-works** / **Store-works** | second station gets an unmarked page; [`docs/tm063_results.md`](docs/tm063_results.md) |
| TM.0.6.4 English find without unique rare | **Fail** / **Store-works** | clutter hapax bound as acts; [`docs/tm064_results.md`](docs/tm064_results.md) |
| TM.0.6.5 concurrent bind | **Store-works** / **Fail** | one CS here from the page in play; [`docs/tm065_results.md`](docs/tm065_results.md) |
| TM.0.6.6 correct dirty English S | **Fail** / **Store-works** | train S n=1 `push`; C bound `xenon`; [`docs/tm066_results.md`](docs/tm066_results.md) |
| TM.0.6.7 in-hand new-here | **Fail** / **Store-works** | leftover walk gone; C bound `neon` in-hand; [`docs/tm067_results.md`](docs/tm067_results.md) |
| TM.0.6.8 find-novel | **Store-works** / **Store-works** | C bound `adjust`; [`docs/tm068_results.md`](docs/tm068_results.md) |
| TM.0.6.9 find-novel without unique two-rare | **Fail** / **Store-works** | train bound `neon`, C bound `xenon`; [`docs/tm069_results.md`](docs/tm069_results.md) |
...
| TM.0.8.1 one return | **Fail** / **Store-works** | split gone; retrieve used `xenon`; [`docs/tm081_results.md`](docs/tm081_results.md) |
...
| TM.0.11.FAMILY (**Ex0S 0.0.003**) | **252/252** / delta 0 | depth 4 hold-out; first-hop D/F; G revise; [`docs/tm011family_results.md`](docs/tm011family_results.md) |
