"""TM.0.5.3: use the fact — same S, A PRESS, C HOLD."""
...
from experiments.run_tm052 import clutter_prose, live_free, wiki_prose
from experiments.run_tm053 import make
...
def test_wiki_has_no_motor_or_station():
...
def test_skips_stay_skipped():
    ...
    src_exp = Path(REPO_ROOT / "experiments" / "run_tm053.py").read_text(encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_wiki_has_no_motor_or_station()
