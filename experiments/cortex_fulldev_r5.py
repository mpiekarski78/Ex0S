"""TM.0.23.CORTEX.FULLDEV.R5 — D0–D12 on sealed TM023.FULL.R5. worlds."""
...
from experiments.cortex_fulldev_r5_worlds import sealed_pair_seeds
...
def run_fulldev_r5_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
