"""TM.0.23.CORTEX.D7.R2.GATE — historical score_d7 after D1–D6 prefix."""
...
from experiments.cortex_d7_r2_worlds import sealed_pair_seeds
...
def run_gate_life(seeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d7r2_{seeds.role}_") as tmp:
...
def run_d7_r2_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
