"""TM.0.23.CORTEX.FULLDEV.R6 — D0–D12 on sealed TM023.FULL.R6. worlds."""
...
from experiments.cortex_fulldev_r6_worlds import sealed_pair_seeds
...
def run_fulldev_r6_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
