"""TM.0.23.CORTEX.D4.R1.GATE — historical score_d4; lives from TM023.D4.R1. seeds."""
...
from experiments.cortex_d4_r1_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d4r1_{seeds.role}_") as tmp:
...
def run_d4_r1_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
