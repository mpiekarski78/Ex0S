"""TM.0.23.CORTEX.D6.R1.GATE — historical score_d6 after D1–D5 prefix."""
...
from experiments.cortex_d6_r1_worlds import sealed_pair_seeds
...
def run_gate_life(seeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d6r1_{seeds.role}_") as tmp:
...
def run_d6_r1_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
