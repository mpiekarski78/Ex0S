"""TM.0.23.CORTEX.V13.GATE — v11 scorers; lives from TM023.V13 seeds."""
...
from experiments.cortex_v13_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"v13gate_{seeds.role}_") as tmp:
...
def run_v13_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
