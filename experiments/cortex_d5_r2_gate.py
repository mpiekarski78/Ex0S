"""TM.0.23.CORTEX.D5.R2.GATE — historical score_d5 after D1–D4 prefix."""
...
from experiments.cortex_d5_r2_worlds import sealed_pair_seeds
...
def run_gate_life(seeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d5r2_{seeds.role}_") as tmp:
...
def run_d5_r2_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
