"""TM.0.23.CORTEX.D4.R2.GATE — historical score_d4; lives from TM023.D4.R2. seeds."""
...
from experiments.cortex_develop_scorers import score_d0, score_d4
from experiments.cortex_d4_r2_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d4r2_{seeds.role}_") as tmp:
        ...
        return {
            ...
            "stages": {"D0": d0, "D4": d4},
            "eligible_pair_member": bool(d0.get("ok") and d4.get("ok")),
        }
