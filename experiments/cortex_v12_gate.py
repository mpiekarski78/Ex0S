"""TM.0.23.CORTEX.V12.GATE — v11 scorers; lives from TM023.V12 seeds."""
...
from experiments.cortex_v12_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"v12gate_{seeds.role}_") as tmp:
...
def run_v12_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
