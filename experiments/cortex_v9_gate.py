"""TM.0.23.CORTEX.V9.GATE — D1 on press/harm only; D2 may attach get/drop."""
...
from experiments.cortex_v9_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"v9gate_{seeds.role}_") as tmp:
...
def run_v9_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
