"""TM.0.23.CORTEX.FULLDEV.R1 — D0–D12 on sealed TM023.FULL.R1. worlds."""
...
from experiments.cortex_fulldev_r1_worlds import sealed_pair_seeds
...
def run_fulldev_r1_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
    ...
    return {
        ...
        "eligible_for_000005": bool(development_gate_clear and maturation_ok),
        "earned_next": False,
        "ex0s": None,
        "product": "0.0.004",
