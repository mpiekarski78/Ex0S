"""TM.0.23.CORTEX.FULLDEV.R3 — D0–D12 on sealed TM023.FULL.R3. worlds."""
...
from experiments.cortex_fulldev_r3_worlds import sealed_pair_seeds
...
def run_fulldev_r3_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
