"""TM.0.23.CORTEX.D3.R3.GATE — historical score_d3; lives from TM023.D3.R3. seeds."""
...
from experiments.cortex_d3_r3_worlds import sealed_pair_seeds
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"d3r3_{seeds.role}_") as tmp:
...
def run_d3_r3_gate_battery(*, seed_hex: str, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
