"""TM.0.23.CORTEX.V5.GATE — D0–D2 with bind_actuators opaque handles."""
...
def run_gate_life(seeds: LifeSeeds, *, device: str = "cpu") -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix=f"v5gate_{seeds.role}_") as tmp:
...
def run_v5_gate_battery(*, n_pairs: int = 16, device: str = "cpu") -> dict[str, Any]:
